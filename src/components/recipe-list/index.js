    ...
    return(
        <div>
           <div className="p-4 mx-auto lg:max-w-6xl md:max-w-4xl sm:max-w-full">
            ...
            <Link href={'/'} className="block w-64 px-4 py-2 text-lg text-green-600 mb-4 bg-white border border-green-500 rounded hover:bg-green-50 transition duration-300 ease-in-out">
            Go Home</Link>
